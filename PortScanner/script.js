...
makeMobscan: function () { //create Scanning for Mobile device popUp
        ...
        ddiv.html("<h1>SCAN FAIL</h1>"); // set content of div
...
makeMobhack: function () { //create Hacking Mobile Device popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>SCAN ERROR</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeMobcopy: function () { // make Copy Mobile Device popup
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>SCAN COMPLETE</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeFirescan: function () { //create Scanning Firewall popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>SCAN RUNNING</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },    
makeFirebypass: function () { //create Bypassing Firewall popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>STEALTH SCAN ACTIVE</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },    
makeFiredisable: function () { //create Disabling Firewall popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>PING SCAN ACTIVE</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAvscan: function () { //create Scanning Antivirus popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>TCP SCAN ACTIVE</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAvbypass: function () { //create Bypassing Antivirus popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>UDP SCAN ACTIVE</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAvdisable: function () { //create Disable Antivirus popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>PORT LOCKED</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAlarmdis: function () { //create Alarm Disabled
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>PORT UNLOCKED</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
