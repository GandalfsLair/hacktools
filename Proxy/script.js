...
makeMobscan: function () { //create Scanning for Mobile device popUp
        ...
        ddiv.html("<h1>Proxy Network Enabled</h1>"); // set content of div
...
makeMobhack: function () { //create Hacking Mobile Device popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Proxy Network Disabled</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeMobcopy: function () { // make Copy Mobile Device popup
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Node 1 - U.S. Engaged</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeFirescan: function () { //create Scanning Firewall popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Node 2 - Prague - Engaged</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },    
makeFirebypass: function () { //create Bypassing Firewall popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Node 3 - North Korea - Engaged</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },    
makeFiredisable: function () { //create Disabling Firewall popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Node 4 - Moscow - Engaged</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAvscan: function () { //create Scanning Antivirus popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Node 5 - Mexico - Engaged</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAvbypass: function () { //create Bypassing Antivirus popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Node 6 - Paris - Engaged</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAvdisable: function () { //create Disable Antivirus popUp
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Proxy Link Generated</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
makeAlarmdis: function () { //create Alarm Disabled
        ...
        ddiv.addClass("accessGranted"); // add class to the div
        ddiv.html("<h1>Proxy Link Activated</h1>"); // set content of div
        $(document.body).prepend(ddiv); // prepend div to body
        return false;
    },
